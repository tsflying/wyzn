...
<div id="sidebar">
<div id="services">
<p class="Services"><a href="#">服务项目</a></p>
<ul>
...
<div class="g"><img src="<%=path%>/imgs/wyzn1.png"  alt="img" style=" width: 227px; height: 224px;"/></div>
<div class="d"><br /><p><span class="s">公司立足于高科技领域的前沿.</span></p>  <p>以敏锐的市场发展眼光，壮大公司的整体实力。</p><br /> <br /> <p>以“共同发展、互惠互利”的合作精神，与IT行业众多合作伙伴一起在市场开拓、产品销售以及技术支持和服务等方面进行了广泛的合作。<br /> </p>
<span class="s"> 建立了紧密而又稳固的协作关系 </span>......<br /><br /><br /><br /><br /></div>
